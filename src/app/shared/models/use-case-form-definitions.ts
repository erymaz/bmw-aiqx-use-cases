...
import { BenefitForm, VariantIdentificationCriteria } from './use-case-form-object';
...
export const CAMERA_INTEGRATION_OPTS: FormSelectOption[] = [
  { label: 'LABEL.YES', value: true },
  { label: 'LABEL.NO', value: false },
  { label: 'LABEL.UNKNOWN', value: 'unknown' },
];

export const ORDER_DATA_OPTS: FormSelectOption[] = [
...
export const TRIGGER_OPTS: FormSelectOption[] = [
...
export const VALIDATION_RESULT_OPTS: FormSelectOption[] = [
...
export const PART_AVAILABILITY_OPTS: FormSelectOption[] = [
  { label: 'FORMS.DESCRIPTION.ALREADY_IN_PRODUCTION', value: 'Already in production' },
  { label: 'FORMS.DESCRIPTION.IN_RUNNING_PRE_SERIES', value: 'In running pre-series' },
];
